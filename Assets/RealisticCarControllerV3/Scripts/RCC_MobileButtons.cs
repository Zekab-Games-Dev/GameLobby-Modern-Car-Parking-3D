...
public class RCC_MobileButtons : RCC_Core {
	...
	//custom scripting
	[HideInInspector]
	public Transform Leftgastransform, rightgastransform, Leftbraketransform, rightbraketransform, Leftsteeringtransform, rightsteeringtransform, Leftarrowlefttransform, Leftarrowrighttransform, rightarrowlefttransform, rightarrowrighttransform;
	...
	void Update(){
		...
		case RCC_Settings.MobileController.TouchScreen:
				if (PlayerPrefs.GetInt("ControlSide") == 0)
				{

					gasButton.transform.position = Leftgastransform.position;
					brakeButton.transform.position = Leftbraketransform.position;
					leftButton.transform.position = Leftarrowlefttransform.position;
					rightButton.transform.position = Leftarrowrighttransform.position;
				
				}
				else
                {
					gasButton.transform.position = rightgastransform.position;
					brakeButton.transform.position = rightbraketransform.position;
					leftButton.transform.position = rightarrowlefttransform.position;
					rightButton.transform.position = rightarrowrighttransform.position;
				}
		...
		case RCC_Settings.MobileController.SteeringWheel:
				if (PlayerPrefs.GetInt("ControlSide") == 0)
				{
					...
					gasButton.transform.position = Leftgastransform.position;
					brakeButton.transform.position = Leftbraketransform.position;
					steeringWheel.transform.position = Leftsteeringtransform.position;
				...
				else
				{
					gasButton.transform.position = rightgastransform.position;
					brakeButton.transform.position = rightbraketransform.position;
					steeringWheel.transform.position = rightsteeringtransform.position;
				}
				gyroInput = 0f;
